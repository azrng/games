...
function testFilesAndCatalogExist() {
    ...
    assert(catalog.includes('path: "src/zh-poem/index.html"'), 'catalog should point to the game page');
    assert(catalog.includes('mobilePath: "src/zh-poem/index.html"'), 'catalog should route mobile to the game page');
