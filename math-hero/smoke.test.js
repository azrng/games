...
function testFilesAndCatalogExist() {
    ...
    assert(catalog.includes('path: "math-hero/index.html"'), 'catalog should point to the game page');
    assert(catalog.includes('mobilePath: "math-hero/index.html"'), 'catalog should route mobile to the game page');
