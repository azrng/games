...
function testFilesAndCatalogExist() {
    ...
    assert(catalog.includes('path: "typing-cannon/index.html"'), 'catalog should point to the game page');
    assert(catalog.includes('mobilePath: "typing-cannon/index.html"'), 'catalog should route mobile to the game page');
